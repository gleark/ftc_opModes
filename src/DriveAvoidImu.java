...
public class DriveAvoidImu extends LinearOpMode
{
    ...
    static final double LEGTIME      = 4.0;  //seconds
    static final int    TURNCORR     = -5;  //degrees
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        while (opModeIsActive())
        {
            ...
            if (aButton || bButton  || (runtime.seconds() > LEGTIME))
            {
                // backup.
    ...
    private void rotate(int degrees, double power)
    {
        ...
        degrees =+ TURNCORR;  // Correct for non-ideal
